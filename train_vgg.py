...
import json
import numpy as np
from model import generate_vgg,pixel_crop,number_of_crops,learning_rate
import cv2
...
print(model.summary())
if load_weights:
    model.load_weights("weights/lastVGG.h5")
print(model.summary())

check1 = ModelCheckpoint(filepath="weights/lastVGG.h5",save_best_only=False, save_weights_only=True, verbose=1)
